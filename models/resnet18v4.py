...
model = Sequential([
    ...
    ResidualV4([
        ...
        mapfunc=SpatialConvolution(128,1,1, padding='SAME', name='rconv3')),
    ReLU(name='rrelu2'),
    ResidualV4([
    ...
    ResidualV4([
        ...
        mapfunc=SpatialConvolution(256,1,1, padding='SAME', name='rconv3')),
    ReLU(name='rrelu2'),
    ResidualV4([
    ...
    ResidualV4([
        ...
        mapfunc=SpatialConvolution(512,1,1, padding='SAME', name='rconv3')),
    ReLU(name='rrelu2'),
    ResidualV4([
